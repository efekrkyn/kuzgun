...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "KUZGUN — The Open-Source Palantir Alternative | Live Flights, CCTV, Satellites & OSINT Tools",
    description: "Real-time global intelligence dashboard aggregating live flights, earthquakes, active fires, maritime traffic, and extensive OSINT/Recon tools.",
    type: "website",
    siteName: SITE_NAME,
    locale: "en_US",
    url: SITE_URL,
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "KUZGUN — Open Source Intelligence Platform with Live Tracking & OSINT Tools",
        type: "image/jpeg",
      },
    ],
  },
  twitter: {
    ...
    title: "🛰️ KUZGUN — Open Source Palantir Alternative | Live Tracking + OSINT Tools",
    description: "Explore the ultimate open-source intelligence dashboard. Live flights, CCTV, deep web recon, and more in one sleek interface.",
    creator: "@KuzgunIntel",
    site: "@KuzgunIntel",
  ...
  other: {
    ...
    "apple-mobile-web-app-title": "KUZGUN",
...
const jsonLd = {
  ...
  name: "KUZGUN — OSINT Toolkit & Intelligence Platform",
  alternateName: ["KUZGUN", "Kuzgun OSINT", "Kuzgun Intelligence"],
  url: SITE_URL,
  description: SITE_DESCRIPTION,
