...
/**
 * KUZGU — Worldwide CCTV Camera API v2
...
async function fetchUSEastCameras(): Promise<any[]> {
  ...
  // New York City (Curated Embedded)
  cams.push(
    {
      id: 'nyc-times-square-1', lat: 40.7580, lng: -73.9855,
      name: 'Times Square Live', city: 'New York', country: 'US',
      stream_url: 'https://www.youtube.com/embed/mRe-514tGLs?autoplay=1&mute=1',
      stream_type: 'iframe',
      source: 'YouTube Live',
    },
    {
      id: 'nyc-skyline', lat: 40.7484, lng: -73.9857,
      name: 'New York Skyline Live', city: 'New York', country: 'US',
      stream_url: 'https://www.youtube.com/embed/HGe-3jXN0Q8?autoplay=1&mute=1',
      stream_type: 'iframe',
      source: 'YouTube Live',
    }
  );
