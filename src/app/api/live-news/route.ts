...
const LIVE_FEEDS = [
  ...
  // ── Turkey ──
  // ── Turkey ──
  { id: 'trthaber',  name: 'TRT Haber',     city: 'Ankara',   country: 'TR', lat: 39.933, lng: 32.859, url: 'https://www.youtube.com/@trthaber/live', embed_allowed: false, category: 'mainstream', language: 'tr' },
  { id: 'ntv',       name: 'NTV',           city: 'Istanbul', country: 'TR', lat: 41.008, lng: 28.978, url: 'https://www.youtube.com/@ntv/live', embed_allowed: false, category: 'mainstream', language: 'tr' },
  { id: 'haberturk', name: 'Habertürk TV',  city: 'Istanbul', country: 'TR', lat: 41.010, lng: 28.980, url: 'https://www.youtube.com/@HaberturkTV/live', embed_allowed: false, category: 'mainstream', language: 'tr' },
  { id: 'cnnturk',   name: 'CNN Türk',      city: 'Istanbul', country: 'TR', lat: 41.012, lng: 28.975, url: 'https://www.youtube.com/@cnnturk/live', embed_allowed: false, category: 'mainstream', language: 'tr' },
  { id: 'halktv',    name: 'Halk TV',       city: 'Istanbul', country: 'TR', lat: 41.015, lng: 28.970, url: 'https://www.youtube.com/@halktvcomtr/live', embed_allowed: false, category: 'mainstream', language: 'tr' },
  { id: 'sozcutv',   name: 'Sözcü TV',      city: 'Istanbul', country: 'TR', lat: 41.020, lng: 28.980, url: 'https://www.youtube.com/@Sozcutv/live', embed_allowed: false, category: 'mainstream', language: 'tr' },
  { id: 'ahaber',    name: 'A Haber',       city: 'Istanbul', country: 'TR', lat: 41.005, lng: 28.990, url: 'https://www.youtube.com/@ahaber/live', embed_allowed: false, category: 'mainstream', language: 'tr' },
