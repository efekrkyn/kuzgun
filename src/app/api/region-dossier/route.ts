  ...
  try {
    ...
    const [countryResult, wikiResult, hosResult] = await Promise.allSettled([
      ...
      (async () => {
        ...
        } catch (e) { console.warn('[KUZGU] Country fetch error:', e instanceof Error ? e.message : e); }
        return null;
      })(),
      ...
      (async () => {
        ...
        } catch (e) { console.warn('[KUZGU] Wikipedia fetch error:', e instanceof Error ? e.message : e); }
        return null;
      })(),
      ...
      (async () => {
        ...
        } catch (e) { console.warn('[KUZGU] Wikidata fetch error:', e instanceof Error ? e.message : e); }
        return null;
      })(),
    ]);
