 ...
 * ║                                                                 ║
 * ║  Subscribes to KUZGU feeds + external providers (Lattice),     ║
...
export class PolybolosClient {
  ...
  /** Connect to the KUZGU SSE stream endpoint */
  ...
  /**
   * Ingest raw KUZGU data and translate it into Polybolos entities.
  ...
  private getActiveFeedCount(): number {
    let count = 0;
    // Count KUZGU feeds that have data
