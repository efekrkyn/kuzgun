          ...
          >
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                ...
                <span className="hud-text text-[10px] text-[var(--text-primary)]">GÖRÜNÜMÜ PAYLAŞ</span>
              </div>
            ...
            <div className="mb-3 p-2 rounded-lg bg-[var(--bg-void)] border border-[var(--border-primary)]">
              <div className="flex items-center gap-1.5 mb-1">
                ...
                <span className="text-[7px] font-mono text-[var(--text-muted)] tracking-widest">MEVCUT GÖRÜNÜM</span>
              </div>
            ...
            <div className="mb-3">
              <div className="flex items-center gap-1.5 mb-1">
                ...
                <span className="text-[7px] font-mono text-[var(--text-muted)] tracking-widest">PAYLAŞILABİLİR BAĞLANTI</span>
              </div>
            ...
            <div className="flex gap-2">
              <a
                href={`https://twitter.com/intent/tweet?text=${encodeURIComponent('🏛️ KUZGU — Global Intelligence Dashboard')}&url=${encodeURIComponent(generateShareUrl())}`}
                target="_blank"
              ...
              <a
                href={`https://reddit.com/submit?url=${encodeURIComponent(generateShareUrl())}&title=${encodeURIComponent('KUZGU — Open Source Global Intelligence Platform')}`}
                target="_blank"
